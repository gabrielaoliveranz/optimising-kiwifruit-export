...
The APOPHENIA name, branding, and methodology documentation are proprietary. If you intend to deploy a commercial service based on this work, please make contact first.
